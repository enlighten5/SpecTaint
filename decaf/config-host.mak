...
# Configured with: './configure' '--enable-tcg-taint' '--target-list=i386-softmmu' '--enable-force-execution'
all:
prefix=/usr/local
bindir=${prefix}/bin
libdir=${prefix}/lib
...
VERSION=1.0
PKGVERSION=
SRC_PATH=/home/zhenxiao/X_Fuzz/decaf
...
QEMU_INCLUDES=-I$(SRC_PATH)/slirp -I. -I$(SRC_PATH) -I$(SRC_PATH)/fpu -I$(SRC_PATH)/shared/sleuthkit -I$(SRC_PATH)/shared
HELPER_CFLAGS=
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -rdynamic  -g 
ARLIBS_BEGIN=
ARLIBS_END=
LIBS+=  $(SRC_PATH)/shared/sleuthkit/lib/libtsk.a -lbfd -pthread -lgthread-2.0 -pthread -lglib-2.0  -lstdc++
LIBS_TOOLS+=
EXESUF=
